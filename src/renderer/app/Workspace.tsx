...
type selectionType =
  | { obj: ProjectObject; parent: ProjectObject | undefined }
  | undefined;
type selectionContextType = {
  selected: selectionType;
  setSelected: (selection: selectionType) => void;
};
...
export default function Workspace() {
  let [selected, setSelected] = React.useState<selectionType>({
    obj: starterProject,
    parent: undefined,
  });
      ...
      <Row style={mainContent}>
        <Row className="mt-3">
          <Col xs={12}>
            <center>
              <h5
                className="mt-4 mb-3 pb-1 text-warning"
