  ...
  return (
    <div style={sidePanel}>
      <Col style={titlePart}>
        ...
        <hr />
        {/* <Row className="m-3 mx-0 d-flex SidepanelTitle"> */}
        <h5 className="ps-4" style={subtitleColor}>
          <i className="fa fa-home pe-2" aria-hidden="true"></i> Side Panel
        </h5>
        {/* </Row> */}
      </Col>
      ...
      <Col style={optionsPart}>
        ...
        <SaveASProjectOption />
        <SaveProjectOption />
        <h6 className="ps-5 mb-4 sidepanelOptionsTitle text-white-50">
          <i className="fa fa-home pe-2" aria-hidden="true"></i> Import Links
          from Project
        </h6>
        <h6 className="ps-5 mb-4 sidepanelOptionsTitle text-white-50">
          <i className="fa fa-home pe-2" aria-hidden="true"></i> Close Project
        </h6>
        <h6 className="ps-5 mb-4 sidepanelOptionsTitle text-white-50">
          <i className="fa fa-home pe-2" aria-hidden="true"></i> New Project
        </h6>
        <h6 className="ps-5 mb-4 sidepanelOptionsTitle text-white-50">
          <i className="fa fa-home pe-2" aria-hidden="true"></i> Download
          Project to Folder
        </h6>
